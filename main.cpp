...
//* @param character 字符集
namespace Mysql {
#define Sql_FIELD "mysql."
const string kurl = "url";
const string kPort = "port";
const string kdbname = "dbname";
const string kusername = "username";
const string kpassword = "password";
onceToken token1(
    []() { 
        mINI::Instance()[kurl] = "10.201.148.179";
        mINI::Instance()[kPort] = 3306;
        mINI::Instance()[kdbname] = "wvp";
        mINI::Instance()[kusername] = "wvps";
        mINI::Instance()[kpassword] = 123456;
    },
    nullptr);
} // namespace Http
...
int start_main(int argc,char *argv[]) {
    {
        ...
        try {
            ...
            if (3393) {
                ...
                const string sqlurl = mINI::Instance()[Mysql::kurl];
                unsigned short sqlPort = mINI::Instance()[Mysql::kPort];
                const string sqldbname = mINI::Instance()[Mysql::kdbname];
                const string sqlysrname = mINI::Instance()[Mysql::kusername];
                const string sqlpwd = mINI::Instance()[Mysql::kpassword];

                SqlPool::Instance().Init(sqlurl, sqlPort, sqldbname, sqlysrname, sqlpwd);
                SqlPool::Instance().setSize(20);
